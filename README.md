...
| <img src="[https://tse4.mm.bing.net/th?id=OIP.zU3UWFU3dREt9TXVHJmwOAHaEK&pid=Api&P=0&h=180](https://tse1.mm.bing.net/th?id=OIP.mcLw9zqcMHirICdVT3-bdAHaD4&pid=Api&P=0&h=180)" alt="img"  width="450"/> | [Transfer Learning on both image and text](https://github.com/yasi44/TransferLearning) | Text and image | - | Get pretrained models (for both image and text) from tensorflow hub and retrain them on a set of data to achieve our business goal. |

## Data Processing (ETL)
|   | Project     | Data | Tools/Techniques | Description                       | 
| :-------- | :------- | :-------| :-------- | :-------------------------------- |
| <img src="https://tse1.mm.bing.net/th?id=OIP.vghZdgGqsUCcUIl62IiEjAHaHa&pid=Api&P=0&h=180" alt="img"  width="450"/> | [Accelerated ETL](https://github.com/yasi44/PySpark_Snippets) | Price | - | Some pieces of my development for accelerating data processing using PySpark. |
